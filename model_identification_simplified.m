...
Parameters = [struct('Name', 'L1', 'Value', model.L1, 'Unit', 'm',      'Minimum', 0.05,  'Maximum', 0.15, 'Fixed', true);
              ...
              struct('Name', 'c',  'Value', model.c,  'Unit','rad/s^2V','Minimum', -10.0, 'Maximum', 10.0, 'Fixed', true);
              struct('Name', 'dt',  'Value', Ts,       'Unit','rad/s^2V','Minimum', -5.0, 'Maximum', 5.00, 'Fixed', true);
              ];
...
RMSE_pos = acc(y(:,1),sts_dec_pos);
RMSE_spd = acc(y(:,2),sts_dec_spd);
...
load("saved_data\27-Sep-2021 14_14_20-4meas-hangin-down.mat");
%[theta1,theta2,dtheta1,dtheta2]=cut_down(theta1,theta2,dtheta1,dtheta2,1000*1.55)
Ts = input.time(2) - input.time(1);
theta1 = merge_theta(theta1,dtheta1);
...
RMSE_pos1 = acc(y(:,1),sts_dec_pos1);
RMSE_pos2 = acc(y(:,2),sts_dec_pos2);
RMSE_spd1 = acc(y(:,3),sts_dec_spd1);
RMSE_spd2 = acc(y(:,4),sts_dec_spd2);
