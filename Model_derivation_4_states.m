...
syms theta_1(t) theta_2(t) L1 L2 m_1 m_2 g C1 b1 b2
...
% equations of motion 
deq1 =  K*U_in == diff(dL_dtheta_1, t) - dL_theta_1 + diff(D, dtheta_1(t));   % th1
...
nonlinfun = subs(nonlinfun, [vars(1), vars(2), vars(3), vars(4)], [sym('x_1'), sym('x_2'), sym('x_3'), sym('x_4')])
