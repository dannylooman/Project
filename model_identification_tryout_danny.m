...
% output array
y = [theta1.angle, theta2.angle, theta1.dot, theta2.dot];
...
InitialStates = [struct('Name', 'x1', 'Value', theta1.angle(1), 'Unit', 'rad',   'Minimum', -pi, 'Maximum', pi, 'Fixed', true);
                 struct('Name', 'x2', 'Value', theta2.angle(1), 'Unit', 'rad',   'Minimum', -pi, 'Maximum', pi, 'Fixed', true);
